...
{
    //파일 입력
    std::ifstream ifsFilePath("C:\\Users\\Dev02Notebook\\Desktop\\junhyung\\student_manage_program_1pointer\\student_list.txt");
...
int main()
{
    ...
    std::vector<STUDENT_DATA*> pArrStudentInfo;
